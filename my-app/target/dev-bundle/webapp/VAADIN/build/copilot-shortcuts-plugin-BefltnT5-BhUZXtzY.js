import { X as Xu, V as Vl, y as y$1, A, e as ee, b as le, r as pc, s as ld } from "./indexhtml-ChU1hefb.js";
...
var x = (s, i, h, p) => {
  for (var o2 = i, n = s.length - 1, r; n >= 0; n--)
    (r = s[n]) && (o2 = r(o2) || o2);
  return o2;
};
...
function a(s) {
  return ee`<span class="kbds">${pc(s)}</span>`;
}
const C = Xu({
