import { T as jl, V as Vl, X as Xu, U as su, b as le$1, y as y$1, W as Ru, w as wt, N as gn, D as Do, a as Re$1, Y as Pu, _ as ou, $ as du, m as m$1, c as yn, B as Bo, a0 as od, e as ee$1, A, a1 as nn, a2 as Po, a3 as ju, l as lc, C as Cu, a4 as Tu, O as ce$1, o as Ve, a5 as sd, a6 as ht, a7 as V$1, a8 as Kc, a9 as Du, aa as ku, ab as Ju, K as pe$1, ac as _l, q as qc, ad as $u, f as ad, ae as ko, af as tt$1, i as id, s as ld, ag as gl, ah as Qu, ai as ed, r as pc, aj as Bu, ak as Wc, al as tu, M as Mu, am as No, an as Uu, ao as So, ap as oc, aq as Co, ar as Zu } from "./indexhtml-ChU1hefb.js";
import { b, h } from "./state-Bd4w3-in-BN33iN1L.js";
import { f } from "./query-BykXNUlT-DDC0EGul.js";
import { o } from "./icons-D7qmJ5FK-DRBJi7xY.js";
import { i as i$1 } from "./overlay-monkeypatch-CpxYoHZm-BEiXD_1q.js";
import { T as T$1 } from "./index-BIwtu2ls-DOO5iFUn.js";
...
function Mt(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? Se : (t.offsetHeight - (t.position === "bottom" ? Lt : 0) - o2 * Se - i * Dt) / n;
  });
}
var _t = Object.defineProperty, Ot = Object.getOwnPropertyDescriptor, j = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? Ot(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
  return n && o2 && _t(t, i, o2), o2;
};
const le = "data-drag-initial-index", J = "data-drag-final-index";
let M = class extends lc {
  constructor() {
    super(...arguments), this.position = "right", this.opened = false, this.keepOpen = false, this.resizing = false, this.closingForcefully = false, this.draggingSectionPanel = null, this.panelCountChanged = ou(() => {
      this.refreshSplit();
    }, 100), this.documentMouseUpListener = () => {
      this.resizing && y$1.emit("user-select", { allowSelection: true }), this.resizing = false, m$1.setDrawerResizing(false), this.removeAttribute("resizing");
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        this.setActualSize(), le$1.panels.filter((o2) => !o2.floating && o2.panel === this.position).forEach((o2) => {
          le$1.updatePanel(o2.tag, n);
        });
      });
      ...
      this.cleanUpDragging(), le$1.updateOrders(e), document.removeEventListener("mouseup", this.sectionPanelDraggingFinished), document.removeEventListener("mousemove", this.sectionPanelDragging), this.refreshSplit();
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      () => le$1.getAttentionRequiredPanelConfiguration(),
      () => {
        const t = le$1.getAttentionRequiredPanelConfiguration();
  ...
  firstUpdated(e) {
    super.firstUpdated(e), this.resizeElement.addEventListener("mousedown", (t) => {
      t.button === 0 && (this.resizing = true, m$1.setDrawerResizing(true), this.setAttribute("resizing", ""), y$1.emit("user-select", { allowSelection: false }));
    });
  }
  updated(e) {
    super.updated(e), e.has("opened") && this.opened && this.hasAttribute($u) && (this.removeAttribute($u), le$1.clearAttention());
  }
...
class Ht {
  ...
  adjust(t, i, n, o2, s) {
    let a, c, m, x;
    const A2 = document.documentElement.getBoundingClientRect().width, q = document.documentElement.getBoundingClientRect().height;
    return (o2 + i) / 2 < A2 / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), x = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${A2 - o2}px`), a = void 0, x = Math.max(0, A2 - o2)), (n + s) / 2 < q / 2 ? (c = Math.max(0, n), t.style.setProperty("--top", `${c}px`), t.style.setProperty("--bottom", ""), m = void 0) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${q - s}px`), c = void 0, m = Math.max(0, q - s)), {
      left: a,
      right: x,
      top: c,
      bottom: m
...
var Nt = Object.defineProperty, jt = Object.getOwnPropertyDescriptor, B = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? jt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
...
let I = class extends lc {
  constructor() {
    super(), this.javaPluginSectionOpened = false, this.hotswapSectionOpened = false, this.hotswapTab = "hotswapagent", this.downloadStatusMessages = [], this.downloadProgress = 0, this.onDownloadStatusUpdate = this.downloadStatusUpdate.bind(this), this.handleESC = (e) => {
      m$1.active && e.key === "Escape" && le$1.updatePanel(ie.tag, { floating: false });
    }, this.reaction(
  ...
  connectedCallback() {
    super.connectedCallback(), y$1.on("set-up-vs-code-hotswap-status", this.onDownloadStatusUpdate), this.addESCListener();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), y$1.off("set-up-vs-code-hotswap-status", this.onDownloadStatusUpdate), this.removeESCListener();
  }
  render() {
    const e = {
    ...
    return ee$1`
      ...
      <div part="footer">
        <vaadin-button
          id="close"
          @click="${() => le$1.updatePanel(ie.tag, { floating: false })}"
          >Close
        </vaadin-button>
      </div>
    `;
  ...
  renderPluginInstalledContent() {
    return ee$1` <p>You have a running plugin. Enjoy your awesome development workflow!</p> `;
  }
  renderPluginIsNotInstalledContent(e) {
    let t = null, i = "Install from Marketplace";
    return e.intellij ? (t = Du, i = "Install from JetBrains Marketplace") : e.vscode ? (t = ku, i = "Install from VSCode Marketplace") : e.eclipse && (t = Tu, i = "Install from Eclipse Marketplace"), ee$1`
      <div>
  ...
  renderHotswapSection(e) {
    ...
    return i === "success" ? (o$1 = o.checkCircle, a = "Java Hotswap is enabled") : i === "warning" ? (o$1 = o.alertTriangle, a = "Java Hotswap is not enabled") : i === "error" && (o$1 = o.alertTriangle, a = "Java Hotswap is partially enabled"), this.hotswapTab === "jrebel" ? t.jrebel ? s = this.renderJRebelInstalledContent() : s = this.renderJRebelNotInstalledContent() : e.intellij ? s = this.renderHotswapAgentPluginContent(this.renderIntelliJHotswapHint) : e.vscode ? s = this.renderHotswapAgentPluginContent(this.renderVSCodeHotswapHint) : s = this.renderHotswapAgentNotInstalledContent(e), ee$1` <details
      ...
      <div part="content">
        ${n !== "none" ? ee$1`${n === "jrebel" ? this.renderJRebelInstalledContent() : this.renderHotswapAgentInstalledContent()}` : ee$1`
  ...
  renderHotswapAgentNotInstalledContent(e) {
    ...
    return ee$1` <div part="hotswap-agent-section-container">${t}</div> `;
  }
    ...
    return ee$1`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          ...
          <div class="hint">
            <ul>
              ${e.intellij ? ee$1`<li>Launch as mentioned in the previous step</li>` : A}
              ${e.intellij ? ee$1`<li>
  ...
  renderHotswapAgentJdkSection(e) {
    const t = yn.jdkInfo?.extendedClassDefCapable, i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === Ee;
    return ee$1`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && Bt("1.3.0", m$1.idePluginState?.version) ? ee$1` <li>Upgrade to the latest IntelliJ plugin</li>` : A}
              ${e.intellij ? ee$1` <li>Launch the application in IntelliJ using "Debug using Hotswap Agent"</li>` : A}
              ${e.vscode ? ee$1` <li>
                    <a href @click="${(n) => this.downloadJetbrainsRuntime(n)}"
                      >Let Copilot download and set up JetBrains Runtime for VS Code</a
                    >
                    ${this.downloadProgress > 0 ? ee$1`<vaadin-progress-bar
                          .value="${this.downloadProgress}"
                          min="0"
                          max="1"></vaadin-progress-bar>` : A}
                    <ul>
                      ${this.downloadStatusMessages.map((n) => ee$1`<li>${n}</li>`)}
                      ${i ? ee$1`<h3>Go to VS Code and launch the 'Debug using Hotswap Agent' configuration</h3>` : A}
                    </ul>
                  </li>` : A}
              <li>
                ${e.intellij || e.vscode ? ee$1`If there is a problem, you can manually
                      <a target="_blank" href="${Re}">download JetBrains Runtime JDK</a> and set up
                      your debug configuration to use it.` : ee$1`<a target="_blank" href="${Re}">Download JetBrains Runtime JDK</a> and set up
      ...
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij ? ee$1`<li>Launch as mentioned in the previous step</li>` : A}
              ${!e.intellij && !i ? ee$1`<li>First install JetBrains Runtime as mentioned in the step above.</li>` : A}
              ${e.intellij ? ee$1`<li>
  ...
  renderJRebelInstalledContent() {
    return ee$1` <div>JRebel is in use. Enjoy your awesome development workflow!</div> `;
  }
  renderHotswapAgentInstalledContent() {
    return ee$1` <div>Hotswap agent is in use. Enjoy your awesome development workflow!</div> `;
  }
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = true, e.preventDefault(), this.downloadStatusMessages = [], gn(`${Ve}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (ce$1("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, Ee];
    });
  }
  ...
  render() {
    ...
    return ee$1`
      ...
      <div aria-hidden="true" class="suffix">
        ${i ? ee$1`<div class="dot ${t.status}"></div>` : A}
      </div>
    `;
  }
};
...
let Le = class extends lc {
  ...
  render() {
    ...
    return ee$1`
      ...
      <div class="content">
        ...
        ${e ? ee$1` <span class="warning"> ${e} </span> ` : A}
      </div>
  ...
  renderPortrait() {
    return m$1.userInfo?.portraitUrl ? ee$1`<div
        class="portrait"
        style="background-image: url('https://vaadin.com${m$1.userInfo.portraitUrl}')"></div>` : A;
  }
  renderDot() {
    return m$1.userInfo?.validLicense ? A : ko.active || ko.expired ? ee$1`<div class="dot warning"></div>` : A;
  }
};
Le = Xt([
...
function Gt() {
  le$1.updatePanel("copilot-feedback-panel", {
    floating: true
...
let ze = class extends lc {
  ...
  render() {
    return ee$1`
      ...
      <div aria-hidden="true" class="suffix">
        ${tt$1.isFeedbackDisplayedAtLeastOnce() ? A : ee$1`<div class="dot info"></div>`}
      </div>
    `;
  }
};
...
function Ze(e) {
  return gn("copilot-switch-user", { username: e }, (t) => t.data.error ? (Do({ type: Re$1.ERROR, message: "Unable to switch user", details: t.data.error.message }), false) : true);
}
...
let ge = class extends lc {
  ...
  render() {
    return ee$1`<span style="flex: 1;  display: flex; justify-content: space-between;"
...
let W = class extends lc {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = false, this.items = [], this.mouseDownListener = (e) => {
      ...
      this.dragging && (this.setOverlayVisibility(false), $.dragging(this, e));
      ...
      this.dragging = false, this.closeMenuMouseMoveListener(e);
      ...
      return i ? Array.from(i).some((o2) => {
        ...
        if (!s)
          return false;
        const a = s.getBoundingClientRect(), c = n.getBoundingClientRect(), m = Math.min(a.x, c.x), x = Math.min(a.y, c.y), A2 = Math.max(a.width, c.width), q = a.height + c.height;
        return _l(new DOMRect(m, x, A2, q), e.clientX, e.clientY);
      }) : false;
      ...
      const e = le$1.getAttentionRequiredPanelConfiguration();
      return e ? e.panel && !e.floating ? (y$1.emit("open-attention-required-drawer", null), true) : (le$1.clearAttention(), true) : false;
    }, this.closeMenu = () => {
      this.menubar._close();
    }, this.openMenu = () => {
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      () => le$1.attentionRequiredPanelTag,
      () => {
        this.toggleAttribute($u, le$1.attentionRequiredPanelTag !== null), this.updateIndicator();
      }
    ), this.reaction(
      () => m$1.active,
      () => {
            ...
            children: [
              {
                ...
                keepOpen: true,
                action: (o2) => {
                  tt$1.setActivationShortcut(!tt$1.isActivationShortcut()), ce(o2, tt$1.isActivationShortcut());
                }
              },
              {
                component: v({
                ...
                keepOpen: true,
                action: (o2) => {
                  tt$1.setActivationAnimation(!tt$1.isActivationAnimation()), ce(o2, tt$1.isActivationAnimation());
                }
              },
              {
                component: v({
                ...
                action: (o2) => {
                  ...
                  a === "ask" ? s = "yes" : a === "no" ? s = "ask" : s = "no", tt$1.setAIUsageAllowed(s), ii(o2);
                }
              },
              {
              ...
              },
              {
                ...
                keepOpen: true,
                action: (o2) => {
                  tt$1.setSendErrorReportsAllowed(!tt$1.isSendErrorReportsAllowed()), ce(o2, tt$1.isSendErrorReportsAllowed());
                }
              },
              { component: "hr" },
              {
              ...
              },
              {
                ...
                action: () => {
                  le$1.updatePanel("copilot-shortcuts-panel", {
                    floating: true
                  });
                }
              },
...
var oi = Object.defineProperty, si = Object.getOwnPropertyDescriptor, F = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? si(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
  return n && o2 && oi(t, i, o2), o2;
};
...
let _ = class extends lc {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      let c = "";
      i < a ? o2 < a ? (c = "nw-resize", this.setAttribute(P, "top left")) : s < a ? (c = "sw-resize", this.setAttribute(P, "bottom left")) : (c = "col-resize", this.setAttribute(P, "left")) : n < a ? o2 < a ? (c = "ne-resize", this.setAttribute(P, "top right")) : s < a ? (c = "se-resize", this.setAttribute(P, "bottom right")) : (c = "col-resize", this.setAttribute(P, "right")) : s < a ? (c = "row-resize", this.setAttribute(P, "bottom")) : o2 < a && (c = "row-resize", this.setAttribute(P, "top")), c !== "" ? (this.rectangleBeforeResizing = this.getBoundingClientRect(), this.style.setProperty("--resize-cursor", c)) : (this.style.removeProperty("--resize-cursor"), this.removeAttribute(P)), this.toggleAttribute(pe, c !== "");
      ...
      (t.includes("top") || t.includes("bottom")) && this.style.setProperty("--section-height", null), t.forEach((o2) => this.setResizePosition(o2, i, n)), m$1.setSectionPanelResizing(true);
    }, this.floatingResizingMouseLeaveListener = () => {
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(pe), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(P), this.panelInfo != null && this.panelInfo.height != null && this.panelInfo?.height > window.innerHeight && (le$1.updatePanel(this.panelInfo.tag, {
      ...
      const { width: t, height: i } = this.getBoundingClientRect(), { left: n, top: o2, bottom: s, right: a } = $.anchor(this), c = window.getComputedStyle(this.container), m = Number.parseInt(c.borderTopWidth, 10), x = Number.parseInt(c.borderBottomWidth, 10);
      le$1.updatePanel(this.panelInfo.tag, {
        width: t,
        height: i - (m + x),
        floatingPosition: {
      ...
      this.hasAttribute($u) && (this.removeAttribute($u), le$1.clearAttention());
    }, this.contentAreaMouseDownListener = () => {
      le$1.bringToFront(this.panelInfo.tag);
      ...
      e.button === 0 && (le$1.bringToFront(this.panelInfo.tag), !this.hasAttribute(P) && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(e) : this.startDragging(e)));
    }, this.panelHeaderMouseUpEventListener = (e) => {
      e.button === 0 && this.startDraggingDebounce.clear();
    }, this.startDragging = (e) => {
      $.draggingStarts(this, e), document.addEventListener("mousemove", this.draggingEventListener), m$1.setSectionPanelDragging(true), this.panelInfo?.floating ? this.toggleAttribute("dragging", true) : this.parentElement.sectionPanelDraggingStarted(this, e), e.preventDefault(), e.stopPropagation();
      ...
      const e = le$1.getPanelByTag(this.panelTag);
      ...
      if (!this.panelInfo)
        return A;
      let e;
      return this.panelInfo.panel === void 0 ? e = "Close the popup" : e = this.panelInfo.floating ? `Dock ${this.panelInfo.header} to ${this.panelInfo.panel}` : `Open ${this.panelInfo.header} as a popup`, ee$1`
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), Qu(this), this.panelInfo?.floating)
          le$1.updatePanel(this.panelInfo.tag, { floating: false });
        else {
          let t;
          ...
          i === void 0 && this.panelInfo.expanded && (i = Number.parseInt(window.getComputedStyle(this).height, 10)), this.parentElement.forceClose(), le$1.updatePanel(this.panelInfo.tag, {
            floating: true,
            expanded: true,
      ...
      this.panelInfo && (e.stopPropagation(), $.anchorLeftTop(this), le$1.updatePanel(this.panelInfo.tag, {
  ...
  connectedCallback() {
    super.connectedCallback(), this.setAttribute("role", "region"), this.reaction(
      ...
      () => le$1.floatingPanelsZIndexOrder,
      () => {
        this.style.setProperty("--z-index-focus", `${le$1.getFloatingPanelZIndex(this.panelTag)}`);
      },
      { fireImmediately: true }
    ), this.reaction(
      () => le$1.getPanelByTag(this.panelTag)?.floatingPosition,
      () => {
  ...
  setResizePosition(e, t, i) {
    const n = this.rectangleBeforeResizing, o2 = 0, s = window.innerWidth, a = 0, c = window.innerHeight, m = Math.max(o2, Math.min(s, t)), x = Math.max(a, Math.min(c, i));
    if (e === "left")
      ...
      const A2 = n.top - x + n.height;
      this.setFloatingResizeDirectionProps("top", x, void 0, A2);
    } else if (e === "bottom") {
      const A2 = x - n.bottom + n.height;
      this.setFloatingResizeDirectionProps("bottom", x, void 0, A2);
    }
  }
  willUpdate(e) {
    super.willUpdate(e), e.has("panelTag") && (this.panelInfo = le$1.getPanelByTag(this.panelTag), this.setAttribute("aria-labelledby", this.panelInfo.tag.concat("-title"))), this.toggleAttribute("floating", this.panelInfo?.floating);
  }
  updated(e) {
    super.updated(e), this.setCssSizePositionProperties(), requestAnimationFrame(() => {
      if (this.panelInfo !== void 0 && this.panelInfo.floating && this.panelInfo.floatingPosition?.top != null && (this.panelInfo?.height === void 0 || this.panelInfo?.width === void 0)) {
        ...
        n && (le$1.updatePanel(this.panelInfo?.tag, {
          height: t,
          width: i,
          floatingPosition: o2
        }), this.setCssSizePositionProperties());
  ...
  render() {
    return this.panelInfo ? ee$1`
      <div part="container">
        <div part="header" class="drag-handle">
          ${this.panelInfo.expandable !== false ? ee$1` <button
      ...
      this.toggleExpand(e), this.startDraggingDebounce.clear();
              ...
              ${le$1.getPanelHeader(this.panelInfo)}
            </button>
          </h2>
  ...
  renderHelpButton() {
    return this.panelInfo?.helpUrl ? ee$1` <button
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      const i = le$1.panels.filter((n) => n.panel === t).map((n) => n.panelOrder).sort((n, o2) => o2 - n)[0];
      Qu(this), le$1.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: i + 1 });
    }
...
y$1.on("undoRedo", (e) => {
  const i = { files: ri(e), uiId: Ru() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o2 = e.detail.undo ? "undo" : "redo";
  wt(o2), ai(Ju.RedoUndo), gn(n, i, (s) => {
    if (!s.data.performed) {
...
let _e = class extends lc {
  ...
  render() {
    return ee$1`<div class="notification-tray">
      ...
      <div
        ...
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!e.details && !e.link}">
            ${Mu(e.details)}
            ${e.link ? ee$1`<a class="ahreflike" href="${e.link}" target="_blank">Learn more</a>` : ""}
          </div>
          <!-- TODO: This needs to be an actual checkbox -->
          ${e.dismissId ? ee$1` <hr class="border-b border-white/10 border-e-0 border-s-0 border-t-0 mb-25 mt-100" />
                <div
                  class="flex gap-75 items-center py-75 relative hover:text-white"
                  @click=${() => {
      this.toggleDontShowAgain(e);
    }}>
                  ${ee$1`${e.dontShowAgain ? o.checkSquare : o.square}`}
                  ${ci(e)}
                </div>` : ""}
        </div>
        <button
...
const hi = {
   ...
   */
  run(e) {
    me || (me = true, queueMicrotask(() => pi())), H.push(e);
    const t = Te;
    return Te += 1, t;
  },
  /**
...
const X = (e, t) => {
  ...
  for (const n of i) n._$AO?.(t, false), X(n, t);
  return true;
}, oe = (e) => {
  let t, i;
  do {
...
function gi(e, t = false, i = 0) {
  const n = this._$AH, o2 = this._$AN;
  if (o2 !== void 0 && o2.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) X(n[s], false), oe(n[s]);
  else n != null && (X(n, false), oe(n));
  else X(this, e);
}
const fi = (e) => {
  e.type == So.CHILD && (e._$AP ??= gi, e._$AQ ??= ui);
};
class vi extends Co {
  constructor() {
...
class mi extends vi {
  ...
  /** @override */
  update(t, [i, n]) {
    return this.hasChanged(n) ? (this.host = t.options && t.options.host, this.element = t.element, this.renderer = i, this.previousValue === He ? this.addRenderer() : this.runRenderer(), this.previousValue = Array.isArray(n) ? [...n] : n, A) : A;
  }
  /** @override */
  reconnected() {
    this.addRenderer();
...
const ot = No(bi), st = No(wi), at = No(yi);
var xi = Object.defineProperty, Pi = Object.getOwnPropertyDescriptor, rt = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? Pi(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
  return n && o2 && xi(t, i, o2), o2;
};
let be = class extends ht {
  constructor() {
...
var Ii = Object.defineProperty, Ci = Object.getOwnPropertyDescriptor, T = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? Ci(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
  return n && o2 && Ii(t, i, o2), o2;
};
const Ne = {
  info: "UI state info",
...
let L = class extends ht {
  ...
  render() {
    let e = "";
    return this.exceptionReport && this.exceptionReport.items.length > 0 && (e = this.exceptionReport.items[this.visibleItemIndex].content), ee$1` <vaadin-dialog
...
`)}`;
  ...
  submitErrorToGithub() {
    ...
    n.length >= 7500 && (T$1(i), n = encodeURIComponent("Please paste report here. It was automatically added to your clipboard."));
...
y$1.on("copilot-project-compilation-error", (e) => {
  if (e.detail.error) {
    ...
    if (e.detail.files && e.detail.files.length > 0) {
      const i = m$1.idePluginState?.supportedActions?.includes("undo") ? ee$1`
            <button
              class="text-white"
              @click="${(n) => {
...
var Ai = Object.defineProperty, $i = Object.getOwnPropertyDescriptor, lt = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? $i(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
  return n && o2 && Ai(t, i, o2), o2;
};
...
y$1.on("endpoint-request", (e) => {
  ...
  y$1.emit("log", {
    ...
    expandedMessage: nn(
      ee$1`Called endpoint ${t.endpoint}.${t.method} with parameters
        <code class="codeblock"><copilot-copy></copilot-copy>${se(n)}</code>`
    ),
    details: "Response: <pending>"
  });
});
y$1.on("endpoint-response", (e) => {
  let t;
  try {
  ...
  n === 200 ? (i.details = `Response: ${se(t)}`, i.expandedDetails = nn(
    ee$1`Response: <code class="codeblock"><copilot-copy></copilot-copy>${se(t)}</code>`
  )) : (i.details = `Error: ${n} ${Si(n)}`, i.type = Re$1.ERROR), y$1.emit("update-log", {
    id: dt(e.detail),
    ...i
  });
});
...
var Ri = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, U = (e, t, i, n) => {
  for (var o2 = n > 1 ? void 0 : n ? Ei(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o2 = (n ? a(t, i, o2) : a(o2)) || o2);
...
let C = class extends ht {
  ...
  renderContent(e) {
    return ee$1` <div class="content">${e}</div> `;
  }
  renderIcon() {
  ...
  renderTooltip(e) {
    ...
    return ee$1`<vaadin-tooltip for="${e}" text="${t}" position="top-start"></vaadin-tooltip>`;
  }
  getFileName() {
    if (this.tooltipText)
...
y$1.on("copilot-java-after-update", (e) => {
  ...
  e.detail.classes.find((n) => n.routePath !== void 0) && y$1.emit("update-routes", {}), Do({
    type: Re$1.INFORMATION,
