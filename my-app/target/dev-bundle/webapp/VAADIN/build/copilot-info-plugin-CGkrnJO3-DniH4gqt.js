import { l as lc, y as y$1, e as ee, m as m$1, c as yn, b as le, B as Bo, A as A$1, d as lu, f as ad, i as id, D as Do, a as Re, V as Vl } from "./indexhtml-ChU1hefb.js";
...
let m = class extends l {
  ...
  renderDevelopmentWorkflowButton() {
    const e = ad();
    let t = "", i = null, o$1 = "";
    return e.status === "success" ? (t = "success", i = o.check, o$1 = "Details") : e.status === "warning" ? (t = "warning", i = o.lightning, o$1 = "Improve Development Workflow") : e.status === "error" && (t = "error", i = o.alertCircle, o$1 = "Fix Development Workflow"), ee`
      <button
        class="mx-50"
